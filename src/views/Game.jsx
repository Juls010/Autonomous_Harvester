...
export default function Game() {
    ...
    return (
        ...
        <div className="h-screen w-full overflow-hidden relative flex flex-col p-2 sm:p-4" style={{ backgroundColor: '#C0D470' }}>
            ...
            <Link to="/" className="group absolute top-2 sm:top-4 left-2 sm:left-4 z-50">
                ...
                >
                    <span className="text-xl sm:text-2xl leading-none inline-block transition-transform duration-500 ease-in-out group-hover:rotate-20"
                        style={{ 
                ...
                <div className="hidden sm:block absolute top-full mt-3 left-0 scale-0 group-hover:scale-100 transition-transform duration-100 origin-top">
            ...
            <button onClick={resetGame} className="group absolute top-2 sm:top-6 right-2 sm:right-6 z-50 flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-[#8C735D] text-[#FDF5E6] font-bold rounded-xl shadow-[0_4px_0_0_#5D4037] hover:bg-[#7D5A44] active:shadow-none active:translate-y-[4px] transition-all"
                ...
                <div className="hidden sm:block absolute top-full mt-3 right-0 scale-0 group-hover:scale-100 transition-transform duration-200 origin-top">
            ...
            <main className="flex-1 flex flex-col lg:flex-row max-w-[1200px] mx-auto w-full items-center justify-center gap-4 sm:gap-6 p-2 sm:p-4 min-h-0">
                ...
                <div className="w-full lg:w-[450px] flex flex-col gap-3 sm:gap-6 shrink-0 z-20">
                    ...
                    <section className="bg-[#A68A73] p-3 sm:p-6 rounded-xl border-4 border-amber-900/50 w-full shadow-[0_5px_0_0_#5D4037]">
                        <h3 className="font-bold text-white mb-2 tracking-widest" style={{ fontFamily: '"VT323", monospace', fontSize: 'clamp(1.5rem, 4vw, 2rem)', lineHeight: '1' }}>
                            COMMANDS
                        </h3>
                        <ul className="space-y-1 sm:space-y-2 text-left text-xs sm:text-sm text-gray-700 font-medium">
                            <li><code className="bg-amber-100 px-1 rounded font-mono text-amber-900 text-[10px] sm:text-xs">PLACE_FARMER R,C,D</code></li>
                            <li><code className="bg-amber-100 px-1 rounded font-mono text-amber-900 text-[10px] sm:text-xs">PLACE_WALL R,C</code></li>
                            <li><code className="bg-amber-100 px-1 rounded font-mono text-amber-900 text-[10px] sm:text-xs">MOVE</code> / <code className="bg-amber-100 px-1 rounded font-mono text-amber-900 text-[10px] sm:text-xs">LEFT</code> / <code className="bg-amber-100 px-1 rounded font-mono text-amber-900 text-[10px] sm:text-xs">RIGHT</code></li>
                        </ul>
                    </section>
            ...
            {report && (
                <div className="absolute bottom-16 sm:bottom-20 right-2 sm:right-6 z-50">
