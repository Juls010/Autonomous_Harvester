...
const TargetCursor = ({
    ...
    useEffect(() => {
        ...
        // --- SOLUCIÓN: POSICIÓN ABIERTA INICIAL ---
        const offset = 18;
        const initialPos = [
            { x: -offset, y: -offset },
            { x: offset - 6, y: -offset },
        ...
        corners.forEach((corner, i) => {
            gsap.set(corner, { x: initialPos[i].x, y: initialPos[i].y });
        });
        // ------------------------------------------
        ...
        const enterHandler = e => {
            ...
            const leaveHandler = () => {
                ...
                if (cornersRef.current) {
                    const cornersArrLeave = Array.from(cornersRef.current);
                    gsap.killTweensOf(cornersArrLeave);
                    const tl = gsap.timeline();
                    cornersArrLeave.forEach((corner, index) => {
                        tl.to(corner, {
